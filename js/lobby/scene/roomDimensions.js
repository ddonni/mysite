...
// 가구(높이 ~2.5) + 그 위 대표작(~3.9) 위로, 벽 글씨(wallLabel.js)가 들어갈
// 여백까지 남긴 높이. 글씨는 대표작 바로 위에 붙여서, 첫 화면에서 왼쪽 위
// 헤더에 최대한 덜 가리게 함.
export const WALL_H = 5.2;
export const WALL_LABEL_Y = 4.4;
// 벽에 거는 대표작(액자/포스터/스탠드)의 가운데 높이와 좌우 간격 — 네 벽이
// 전부 같은 짜임새로 보이게 맞춤.
